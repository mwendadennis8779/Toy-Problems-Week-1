...
function getIncome(basic, benefits) {
    return parseInt(basic + benefits);
}
...
function netIncome(basic, benefits) {
    ...
    else if (gross >= 35000 && income <= 39999){ 
        nhifDeductions = 950
    } 
    else if (income >= 40000 && income <= 44999){ 
        nhifDeductions = 1000
    }
    else if (income >= 45,000 && income <= 49,999){ 
        nhifDeductions = 1100
    }
    ...
    else if( income >=24,001 && income <=32,333) {
        // Calculation of Payee taxable amount
        payee = income * 0.25;
        netSalary = income - payee - 400 - nhifDeductions;
        console.log(netSalary.toFixed(2))
